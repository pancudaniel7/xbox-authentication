...
fun extractX509CertificateKeystorePrivateKey(
    keystorePath: String,
...
fun main(args: Array<String>) {
    ...
    val sslContext: SSLContext = loadCertificateFromKeystore(sslKeystorePath, universalKeystorePassword)
