...
```sh
keytool -genkeypair -alias ssl-key-pair -keyalg RSA -keysize 2048 -keystore ssl-keystore.jks
```
Removed default keys created
```sh
keytool -delete -alias ssl-key-pair -keystore ssl-keystore.jks
```
